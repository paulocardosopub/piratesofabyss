(() => {
  ...
  const MAIN_SHIPS = [
    ...
    { name: "Barco de Pesca Adaptado", type: "Pescador", tier: 1, levelReq: 3, hp: 215, damage: 40, speed: 116, armor: 4, costs: { ouro: 3000, madeira: 40, tecido: 15 } },
  ...
  const SKILL_META = {
    fire: { name: "Canhão de Fogo", icon: "🔥", unlock: 5, cooldown: 5, factor: 3.6, burnDuration: 4, burnFactor: .44, effect: "3,6× de dano e incêndio reforçado por 4s.", materials: ["polvora", "ferro"] },
    ice: { name: "Canhão de Gelo", icon: "❄", unlock: 10, cooldown: 7, factor: 4.8, slowDuration: 5, slowMultiplier: 3.3, effect: "4,8× de dano e lentidão reforçada por 5s.", materials: ["cristal", "tecido"] },
    ghost: { name: "Canhão Fantasma", icon: "👻", unlock: 20, cooldown: 8, factor: 6.8, effect: "6,8× de dano espectral que ignora toda a armadura.", materials: ["ambar", "cristal"] },
  ...
  const SKILL_DAMAGE_LEVEL_GAIN = .80;
